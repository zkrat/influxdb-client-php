...
class WriteApi extends DefaultApi implements Writer
{
     ...
     */
    public function __construct($options, array|null $writeOptions = null, array|null $pointSettings = null)
    {
     ...
     * @throws ApiException
     */
    public function write($data, string|null $precision = null, string|null $bucket = null, string|null $org = null)
    {
     ...
     */
    public function writeRaw(string $data, string|null $precision = null, string|null $bucket = null, string|null $org = null)
    {
        $precisionParam = $this->getOption("precision", $precision);
        $bucketParam = $this->getOption("bucket", $bucket);
        $orgParam = $this->getOption("org", $org);
    ...
    private function getOption(string $optionName, string|null $precision = null): string
    {
